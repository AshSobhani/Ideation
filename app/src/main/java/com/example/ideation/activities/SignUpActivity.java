...
public class SignUpActivity extends AppCompatActivity {
	...
	private void addUserToCollection() {
		...
		//Generate the keys (public and private together) using KeyStore and then get encoded public key
		String encodedPublicKey = generatePublicPrivateKeys(userUID);
	...
	public String generatePublicPrivateKeys(String userUID){
		...
		try {
			...
			//Generate the key pair and get the public key for that device
			KeyPair keyPairAsymmetric = keyPairGenerator.generateKeyPair();
			PublicKey devicePublicKey = keyPairAsymmetric.getPublic();
